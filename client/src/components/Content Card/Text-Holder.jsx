...
export default function TextHolder({title, titleCSS, innerText, textCSS, buttonText, colorText, buttonCss, CSS}){
    return <div className={`max-w-full mt-0 h-full flex-nowrap ${colorText? colorText : 'text-white'} md: text-start text-base md:text-lg
    flex flex-col w-full white-space: nowrap justify-between font-semibold md:bg-transparent ${CSS}`}>
